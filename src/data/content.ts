...
export const people: Person[] = [
  ...
  },
  {
    ...
    type: "Expert",
    bio: "Sarah is therapeut in Emotional Freedom Techniques (EFT) en werkt rond emotionele en relationele patronen. Ze leert je spanning reguleren en met meer rust en helderheid aanwezig zijn in contact met jezelf en anderen.",
  ...
  },
  {
    ...
    role: "Yoga & beweging",
    type: "Expert",
    bio: "Lisa is kinesitherapeut en yogadocent, met focus op herstel, blessurepreventie en duurzame trainingsopbouw bij duursporters. Ze combineert wetenschappelijke kennis met lichaamsbewustzijn, ademhaling en gerichte beweging.",
    logo: "/liv.jpeg",
    isTeamMember: false,
